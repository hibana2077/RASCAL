...
cd ../..
mkdir -p logs
python3 src/train_rascal.py --method rascal --dataset_name cifar100 --data_root ./data \
  --epochs 200 --batch_size 128 --model resnet50 --feat_dim 128 --temp 0.1 \
  --print_freq 100 \
  >> logs/rascal_cifar100.log 2>&1

python3 src/train_linear.py --ckpt ./save/rascal/rascal_cifar100_resnet50_lr_0.5_decay_0.0001_bsz_128_temp_0.1_trial_0/ckpt_last.pth \
